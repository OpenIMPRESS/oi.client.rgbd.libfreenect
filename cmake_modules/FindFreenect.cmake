...
FIND_LIBRARY(FREENECT_freenect_LIBRARY
    NAMES freenect
    PATHS
  /usr/local/lib
  /usr/lib
...
FIND_LIBRARY(FREENECT_freenect_sync_LIBRARY
  NAMES freenect_sync
  PATHS
  /usr/local/lib
  /usr/lib
...
MARK_AS_ADVANCED(
  ...
  FREENECT_freenect_sync_LIBRARY)
...
IF(FREENECT_INCLUDE_DIR)
  IF(FREENECT_freenect_LIBRARY)
    ...
    SET( FREENECT_LIBRARIES
      ${FREENECT_freenect_LIBRARY})
    LIST(APPEND FREENECT_LIBRARIES
      ${FREENECT_freenect_sync_LIBRARY})
